    ...
    return (
        <>
            ...
            <div >
                ...
                <aside className="w-[270px] flex flex-col items-center fixed h-full bg-blue-400 shadow-lg rounded-md py-4">
                ...
                <div className="flex items-center justify-between bg-yellow-50 shadow-md p-4">
                    ...
                    <div className="flex items-center space-x-12">
                        ...
                        <Link to="/" className="text-slate-400 rounded hover:text-gray-900">
                            Home
                        </Link>
